	...
	function calculate_cgpa(){
		...
		for(var i=0; i < grade_class.length; i++){
			 ...
			 student_all_courses[i] = new course_grade(new_student_input.courses[i].title , new_student_input.courses[i].unit, grade_class[i]["value"]) ;
		}
		...
		var cgpa = get_cgpa(student_all_courses) ;
		document.getElementById("cgpa").innerHTML = "CGPA : " + cgpa.toFixed(2) + "<br />"
            +  "ACADEMIC STATUS : " + get_class_by_cgpa(cgpa).toUpperCase() ;
